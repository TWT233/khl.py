...
class Client(Requestable, AsyncRunnable):
    ...
    async def update_listening_music(self, music_name:str, singer:str, software:Union[str, SoftwareTypes]):
        await self.gate.exec_req(api.Game.activity(music_name=music_name, singer=singer, software=software if isinstance(software, str) else software.value, data_type = 2))
